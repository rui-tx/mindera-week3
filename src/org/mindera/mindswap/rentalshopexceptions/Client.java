...
import org.mindera.mindswap.rentalshopexceptions.exceptions.client.ClientException;
import org.mindera.mindswap.rentalshopexceptions.exceptions.client.NotACarException;
...
public class Client {
    ...
    public void loanCar(VehicleBase vehicle) throws ClientException {
        if (vehicle == null) {
